...
$columns = array(
	...
	array('db' => '`u`.`position`',   'dt' => 3, 'field' => 'position'),
	array('db' => '`u`.`office`',     'dt' => 4, 'field' => 'office'),
	array('db' => '`ud`.`email`',     'dt' => 5, 'field' => 'email'),
	array('db' => '`ud`.`phone`',     'dt' => 6, 'field' => 'phone'),
	array('db' => '`u`.`start_date`', 'dt' => 7, 'field' => 'start_date', 'formatter' => function ($d, $row) {
