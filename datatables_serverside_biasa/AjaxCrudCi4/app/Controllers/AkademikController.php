        ...
        $kolom = array(
            ...
            array(
                ...
                'formatter' => function ($d, $row) {
                    return "<img src='assets/images/$d' alt='' width='100'>";
                }
            ),
            array(
                'db' => 'id',
    ...
    public function updateMahasiswa()
    {
        ...
        if ($validation->run() == false) {
            ...
            if ($dataBerkas->getName() == null) {
                ...
                //check apakah ada gambar lama 
                if (is_file('assets/images/' . $foto_lama)) {
